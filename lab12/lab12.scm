...
(define (closer-city lat lon city-a city-b)
  (define city-target (make-city 'city-target lat lon))
  (if (< (distance city-target city-a) (distance city-target city-b))
  (get-name city-a) 
  (get-name city-b)
  )
  )
...
(define (teacher-hold-class teacher)
  (teacher-create (teacher-get-name teacher) (teacher-get-class teacher) (map (lambda (x) (student-attend-class x (teacher-get-class teacher)))
